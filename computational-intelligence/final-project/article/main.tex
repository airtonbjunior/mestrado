...
\multicolumn{1}{c}{\textbf{Base}} & \textbf{Acc} & \multicolumn{4}{c}{\textbf{Precisão}} & \multicolumn{4}{c}{\textit{\textbf{Recall}}} & \multicolumn{5}{c}{\textbf{F1}} \\
 &  & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{Nt} & Avg & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{Nt} & Avg & \multicolumn{1}{c|}{P} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{Nt} & \multicolumn{1}{c|}{Avg} & Avg +/- \\
Tweets2013 & 0.6 & 0.7 & 0.5 & 0.6 & 0.6 & 0.5 & 0.4 & 0.8 & 0.5 & 0.6 & 0.4 & 0.6 & 0.6 & 0.5 \\ \hline
Tweets2014 & 0.5 & 0.7 & 0.4 & 0.5 & 0.5 & 0.4 & 0.3 & 0.8 & 0.5 & 0.5 & 0.4 & 0.6 & 0.5 & 0.4 \\ \hline
...
\multirow{6}{*}{\rotatebox{90}{Modelo A}} & Twitter2013 & 0.5 & 0.5 & 0.7 & \textbf{0.6} & 0.5 \\ 
 ...
 & LiveJournal & 0.6 & 0.6 & 0.6 & \textbf{0.6} & \textbf{0.6} \\ 
 & Todas & 0.6 & 0.4 & 0.7 & \textbf{0.6} & 0.5\\ \hline
 \multirow{6}{*}{\rotatebox{90}{Modelo C}} & Twitter2013 & 0.5 & 0.5 & 0.7 & \textbf{0.6} & 0.5 \\ 
 & Twitter2014 & 0.5 & 0.4 & 0.6 & 0.5 & 0.4 \\ 
 & Sarcasm & 0.3 & 0.1 & 0.3 & 0.3 & {\ul 0.2} \\ 
 & SMS2013 & 0.6 & 0.4 & 0.8 & \textbf{0.6} & 0.4 \\ 
 & LiveJournal & 0.6 & 0.6 & 0.6 & \textbf{0.6} & \textbf{0.6} \\ 
 & Todas & 0.6 & 0.4 & 0.7 & \textbf{0.6} & 0.5
\end{tabular}
