...
No presente trabalho, o cálculo do \emph{fitness} de cada solução candidata será feito utilizando um classificador de sentimentos disponível para utilização. Classificadores como \cite{Rodrigues2016}
