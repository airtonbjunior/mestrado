...
def evaluateTweets2013Messages(model):
    ...
    print("[precision_positive]: " + str(round(precision_positive, 2)))
    print("[precision_negative]: " + str(round(precision_negative, 2)))
    print("[precision_neutral]: " + str(round(precision_neutral, 2)))    
    print("[precision_avg]: " + str(round(precision_avg, 2)))
    print("[recall_positive]: " + str(round(recall_positive, 2)))
    print("[recall_negative]: " + str(round(recall_negative, 2)))
    print("[recall_neutral]: " + str(round(recall_neutral, 2)))
    print("[recall avg]: " + str(round(recall_avg, 2)))
    print("[f1_positive]: " + str(round(f1_positive, 2)))
    print("[f1_negative]: " + str(round(f1_negative, 2)))
    print("[f1_neutral]: " + str(round(f1_neutral, 2)))
